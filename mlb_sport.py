...
# ON FOR A GRADE RUN, 2026-09-18. Not yet accepted - the grade has not been
# read at the time of writing. If it does not beat hitters 9/10 days at a
# -0.53% mean edge, this goes back to the empty list.
STATCAST_HITTER_FEATURES = ["ewm_sc_xwobacon", "ewm_sc_barrel_rate"]
# STATCAST_HITTER_FEATURES: list[str] = []          # the graded-as-of-now state
# STATCAST_HITTER_FEATURES = ["ewm_sc_xwobacon", "ewm_sc_barrel_rate",
